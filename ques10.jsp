...
<input type="radio" name="answer" value="magnetic tape">mangnetic tape
</div>
<div class="row" id="op2">
<input type="radio" name="answer" value="printer">printer
</div>
<div class="row"  id="op3"> 
<input type="radio" name="answer" value="VDU terminal">VDU terminal
</div>
<div class="row"  id="op4">
<input type="radio" name="answer" value="assembler">assembler
</div>
