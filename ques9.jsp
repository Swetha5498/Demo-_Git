...
<body>
<form  method="POST"  action="ques10.jsp">
...
9.The total set of interlinked hypertext documents worldwide is
...
<input type="radio" name="answer" value="WWW">WWW
</div>
<div class="row" id="op2">
<input type="radio" name="answer" value="browser">browser
</div>
<div class="row"  id="op3"> 
<input type="radio" name="answer" value="HTTP">HTTP
</div>
<div class="row"  id="op4">
<input type="radio" name="answer" value="B2B">B2B
</div>
