...
if(g.equals("an application suit"))
{ 
...
<body>
<form  method="POST"  action="ques7.jsp">
...
<input type="radio" name="answer" value="Malicious Intent" required>Malicious Intent 
</div>
<div class="row" id="op2">
<input type="radio" name="answer" value="Sabotage" required>Sabotage
</div>
<div class="row"  id="op3"> 
<input type="radio" name="answer" value="Accident Errors " required>Accident Errors 
</div>
<div class="row"  id="op4">
<input type="radio" name="answer" value="Espionage Agents" required> Espionage Agents
</div>
