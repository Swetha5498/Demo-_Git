...
<body>
<form  method="POST"  action="ques5.jsp">
...
<div class="col-xs-7">
      ...
      4.which is the process of finding errors in software code?
...
<input type="radio" name="answer" value="compiling">compiling
</div>
<div class="row" id="op2">
<input type="radio" name="answer" value="testing">testing
</div>
<div class="row"  id="op3"> 
<input type="radio" name="answer" value="running">running
</div>
<div class="row"  id="op4">
<input type="radio" name="answer" value="debugging">debugging
</div>
