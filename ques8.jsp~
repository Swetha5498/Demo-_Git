...
<body>
<form  method="POST"  action="ques9.jsp">
...
<input type="radio" name="answer" value="firewall">firewall
</div>
<div class="row" id="op2">
<input type="radio" name="answer" value="proxy server">proxy server
</div>
<div class="row"  id="op3"> 
<input type="radio" name="answer" value="ip address">ip address
</div>
<div class="row"  id="op4">
<input type="radio" name="answer" value="domain name">domain name
</div>
