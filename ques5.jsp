...
<input type="radio" name="answer" value="an application suit">an application suit
</div>
<div class="row" id="op2">
<input type="radio" name="answer" value="shareware">shareware
</div>
<div class="row"  id="op3"> 
<input type="radio" name="answer" value="public domain software">public domain software
</div>
<div class="row"  id="op4">
<input type="radio" name="answer" value="market application">market application
</div>
